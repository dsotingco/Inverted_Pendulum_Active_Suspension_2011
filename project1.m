...
omega = 50;
d = A.*sin(omega.*t);
ddot = A.*omega.*cos(omega.*t);
dddot = -A.*omega.^2.*sin(omega.*t);
% d(1:length(t)) = 0;
% ddot(1:length(t)) = 0;
% dddot(1:length(t)) = 0;
    D = [d;ddot;dddot];
...
%intialize integral of xdoterror
verrorI = 0;
h1(1:length(t)) = 0;
